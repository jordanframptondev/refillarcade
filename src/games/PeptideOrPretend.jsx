...
const REAL = [
  ...
  'SEMAGLUTIDE', 'TIRZEPATIDE', 'PT-141', 'KISSPEPTIN', 'AOD-9604', 'GHK-CU',
  'EPITHALON', 'SELANK', 'SEMAX', 'MOTS-C', 'DSIP', 'THYMOSIN ALPHA-1',
  'GONADORELIN', 'RETATRUTIDE', 'MELANOTAN II', '5-AMINO-1MQ',
]
const PRETEND = [
  'GAINZATROPIN', 'SWOLEMAX-9', 'FLEXORELIN', 'SHREDZEPATIDE', 'JUICEARELIN',
  'ABSOLUTIDE', 'PUMPAMORELIN', 'GLOWTIDE-X', 'YOLOTROPIN', 'SNATCHEDERMIN',
  'VIBECELIN', 'CHADMORELIN', 'THICCTIDE', 'ZADDYZEPATIDE', 'GLUTESAMORELIN',
  'BROSCIENCE-B12', 'SHREDDERALL', 'MAXXOTROPIN', 'GYMTELLIGENCE-4', 'HULKAMORELIN',
]
